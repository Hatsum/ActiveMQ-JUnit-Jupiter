 ...
 */
class EmbeddedActiveMQBrokerExtensionXbeanUriConfigTest {

    @RegisterExtension
    final public EmbeddedActiveMQBroker instance = new EmbeddedActiveMQBroker( "xbean:activemq-simple.xml");
