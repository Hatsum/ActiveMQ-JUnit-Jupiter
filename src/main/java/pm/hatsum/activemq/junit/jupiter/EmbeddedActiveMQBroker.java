 ...
 */
package pm.hatsum.activemq.junit.jupiter;
...
/**
 * An ActiveMQ broker that can be embedded into a test.
 */
public class EmbeddedActiveMQBroker implements BeforeEachCallback, AfterEachCallback {
    ...
    static void setMessageProperties(Message message, Map<String, Object> properties) {
    ...
    public ObjectMessage createMessage(Serializable body, Map<String, Object> properties) {
        ...
        if (body != null) {
            try {
                ...
                throw new EmbeddedActiveMQBrokerException(String.format("Failed to set body {%s} on ObjectMessage", body), jmsEx);
            }
        }
    ...
    public Message peekMessage(String destinationName) {
        ...
        if (brokerDestination == null) {
            throw new IllegalStateException(String.format("peekMessage failure - destination %s not found in broker %s", destination, brokerService.getBrokerName()));
        }
    ...
    static class EmbeddedActiveMQBrokerException extends RuntimeException {
